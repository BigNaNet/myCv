...
:CV_ENV: cvitemwcomment
:SKILL: Proeficient
:COMMENT:  Currently I am working in a Global Company where English is the primary spoken and written language.
:END:
** German
:Properties:
:CV_ENV: cvitemwcomment
:SKILL: Proeficient
:COMMENT: I am able to have a conversation in German. However my written abilities need some improvement.
:END:
